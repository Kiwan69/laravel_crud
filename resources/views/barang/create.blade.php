                ...
                <div class="card-body">
                    <form action="{{ route('barang.store') }}" method="POST" enctype="multipart/form-data">
                        ...
                        <div class="mb-3">
                            ...
                            <input type="text" class="form-control @error('nama_barang') is-invalid @enderror" name="nama_barang" value="{{ old('nama_barang') }}" placeholder="Barang Name" required>
                            @error('nama_barang')
                        ...
                        <div class="mb-3">
                            ...
                            <input type="number" class="form-control @error('id_merek') is-invalid @enderror" name="id_merek" value="{{ old('id_merek') }}" placeholder="ID Merek" required></input>
                            @error('id_merek')
                            <span class="invalid-feedback" role="alert">
                                <strong>{{ $message }}</strong>
                            </span>
